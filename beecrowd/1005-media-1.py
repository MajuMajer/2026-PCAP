...
# --- ANÁLISE (LIAC) ---
# Entrada: duas notas de pontos flutuante A e B (cada uma em uma linha)
# Processamento: média pondera = (A *3.5 +B * 7.5) / 11
...
# Notas A tem peso 3.5 e nota B tem peso 7.5
