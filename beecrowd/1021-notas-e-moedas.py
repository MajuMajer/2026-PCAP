...
'''
# Objetivo: Ler um valor montário e decompõ-lo no MENOR número possível de notas (100, 50, 20, 10, 5, 2, 1) e moedas (0.50, 0.25, 0.10, 0.05, 0.01)
# --- ANÁLISE (LIAC) ---
# Entrada: um valor monetário com 2 casas decimais (ex.: 576.73)
# Processamento: separar parte inteira (reais notas) e parte decimal (centavos moedas); usar divisão inteira (//) para descobrir QUANTAS unidades cabem e o resto da divisão (%) para guardar o que SOBROU para a próxima troca
